...
namespace DESSAU.ControlGestion.Core
{
    ...
    partial void OnNombreChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cliente_Proyecto", Storage="_Proyectos", ThisKey="IdCliente", OtherKey="IdCliente")]
    ...
    partial void OnFechaEvaluacionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Usuario_Evaluacion1", Storage="_Usuario1", ThisKey="IdSupervisor", OtherKey="IdUsuario", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Usuario1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Evaluacions1.Remove(this);
					}
					this._Usuario1.Entity = value;
					if ((value != null))
					{
						value.Evaluacions1.Add(this);
    ...
    partial void OnFechaTerminoChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Cliente_Proyecto", Storage="_Cliente", ThisKey="IdCliente", OtherKey="IdCliente", IsForeignKey=true)]
    ...
    partial void OnPorcentajeAvanceChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PorcentajeAvance", DbType="Decimal(5,4)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Usuario_TimeSheet", Storage="_Usuario", ThisKey="IdUsuario", OtherKey="IdUsuario", IsForeignKey=true)]
		public Usuario Usuario
		{
			get
			{
